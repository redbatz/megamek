...
class EntitySprite extends Sprite {
    ...
    public StringBuffer getTooltip() {
        ...
        if (thisGunEmp == null) {
            ...
            if (!entity.isDone() && this.bv.game.getPhase() == IGame.Phase.PHASE_MOVEMENT) {
            ...
            // In the Movement Phase, unit is done - or in the Firing Phase
                    ...
                    (entity.isDone() && this.bv.game.getPhase() == IGame.Phase.PHASE_MOVEMENT)
                    || this.bv.game.getPhase() == IGame.Phase.PHASE_FIRING) {
