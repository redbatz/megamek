...
import static org.redbat.roguetech.megamek.common.MovePath.MoveStepType.*;
    ...
    public void prepare() {
        ...
        switch (step.getMovementType(isLastStep)) {
            ...
            case MOVE_ILLEGAL:
                ...
                break;
            default:
                if ((step.getType() == BACKWARDS)
                        || (step.getType() == LATERAL_LEFT_BACKWARDS)
                        || (step.getType() == LATERAL_RIGHT_BACKWARDS)) {
