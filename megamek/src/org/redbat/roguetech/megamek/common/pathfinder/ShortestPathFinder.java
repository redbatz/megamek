...
public class ShortestPathFinder extends MovePathFinder<MovePath> {
    ...
    public static class MovePathAStarComparator implements Comparator<MovePath> {
        ...
        public MovePathAStarComparator(Coords destination,
                                       MovePath.MoveStepType stepType, IBoard board) {
            if (destination == null)
                throw new NullPointerException();
            this.destination = destination;
    ...
    private ShortestPathFinder(EdgeRelaxer<MovePath, MovePath> costRelaxer,
                               Comparator<MovePath> comparator, final MovePath.MoveStepType stepType, IGame game) {
     ...
     * @param game
     */
    public static ShortestPathFinder newInstanceOfAStar(final Coords destination, final MovePath.MoveStepType stepType, final IGame game) {
     ...
     * @param game
     */
    public static ShortestPathFinder newInstanceOfOneToAll(final int maxMP, final MovePath.MoveStepType stepType, final IGame game) {
     ...
     * destination.
     */
    public static ShortestPathFinder newInstanceOfGreedy(final Coords destination, final MovePath.MoveStepType stepType,
            final IGame game) {
    ...
    public static int getElevationDiff(final MovePath mp, Coords dest,
        ...
        if (ent.isProne() && !(mp.contains(MovePath.MoveStepType.GET_UP)
                || mp.contains(MovePath.MoveStepType.CAREFUL_STAND))) {
            elevationDiff += 2;
        }
