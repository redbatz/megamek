...
import org.redbat.roguetech.megamek.common.weapons.ppc.*;
...
public class MiscType extends EquipmentType {
        ...
        if (hasFlag(F_CLUB) && (hasSubType(S_HATCHET) || hasSubType(S_SWORD) || hasSubType(S_MACE_THB))) {
            ...
            if (entity.isClanArmor(1) && !entity.hasPatchworkArmor()) {
                ...
                for (int i = 0; i < entity.locations(); i++) {
                    if ((entity.getArmorType(i) == T_ARMOR_FERRO_FIBROUS)
                            || (entity.getArmorType(i) == T_ARMOR_REACTIVE)) {
            ...
            if (entity.isClanArmor(1) && !entity.hasPatchworkArmor()) {
                ...
                int slots = 0;
                for (int i = 0; i < entity.locations(); i++) {
                    if (entity.getArmorType(i) == T_ARMOR_REFLECTIVE) {
                        if (TechConstants.isClan(entity.getArmorTechLevel(i))) {
                            slots++;
                        } else {
                            slots += 2;
            ...
            if (!entity.hasPatchworkArmor()) {
                ...
                int slots = 0;
                for (int i = 0; i < entity.locations(); i++) {
                    if (entity.getArmorType(i) == T_ARMOR_LIGHT_FERRO) {
                        slots++;
                    }
                }
                if ((entity instanceof Mech) && ((Mech) entity).isSuperHeavy()) {
            ...
            if (!entity.hasPatchworkArmor()) {
                ...
                int slots = 0;
                for (int i = 0; i < entity.locations(); i++) {
                    if (entity.getArmorType(i) == T_ARMOR_HEAVY_FERRO) {
                        slots += 3;
                    }
                }
                if ((entity instanceof Mech) && ((Mech) entity).isSuperHeavy()) {
            ...
            if (!entity.hasPatchworkArmor()) {
                ...
                int slots = 0;
                for (int i = 0; i < entity.locations(); i++) {
                    if (entity.getArmorType(i) == T_ARMOR_FERRO_LAMELLOR) {
                        slots += 2;
                    }
                }
                if ((entity instanceof Mech) && ((Mech) entity).isSuperHeavy()) {
            ...
            if (!entity.hasPatchworkArmor()) {
                ...
                int slots = 0;
                for (int i = 0; i < entity.locations(); i++) {
                    if (entity.getArmorType(i) == T_ARMOR_FERRO_FIBROUS_PROTO) {
                        slots += 2;
                    }
                }
                if ((entity instanceof Mech) && ((Mech) entity).isSuperHeavy()) {
    ...
    public static void initializeTypes() {
        ...
        addType(MiscType.createHeatSink());
        addType(MiscType.createJumpJet());
        addType(MiscType.createTreeClub());
        addType(MiscType.createGirderClub());
        addType(MiscType.createLimbClub());
        addType(MiscType.createHatchet());
        addType(MiscType.createStandard());

        // Start of Level2 stuff
        addType(MiscType.createISDoubleHeatSink());
        addType(MiscType.createISDoubleHeatSinkPrototype());
        addType(MiscType.createISFreezerPrototype());
        addType(MiscType.createCLDoubleHeatSink());
        addType(MiscType.createISCASE());
        addType(MiscType.createCLCASE());
        addType(MiscType.createISMASC());
        addType(MiscType.createCLMASC());
        addType(MiscType.createTSM());
        addType(MiscType.createC3S());
        addType(MiscType.createC3SBS());
        addType(MiscType.createC3I());
        addType(MiscType.createNC3());
        addType(MiscType.createISArtemis());
        addType(MiscType.createCLArtemis());
        addType(MiscType.createGECM());
        addType(MiscType.createGECMPrototype());
        addType(MiscType.createCLECM());
        addType(MiscType.createISTargComp());
        addType(MiscType.createCLTargComp());
        addType(MiscType.createMekStealth());
        addType(MiscType.createISFerroFibrous());
        addType(MiscType.createCLFerroFibrous());
        addType(MiscType.createISEndoSteel());
        addType(MiscType.createCLEndoSteel());
        addType(MiscType.createBeagleActiveProbe());
        addType(MiscType.createBeagleActiveProbePrototype());
        addType(MiscType.createBloodhoundActiveProbe());
        addType(MiscType.createTHBBloodhoundActiveProbe());
        addType(MiscType.createCLActiveProbe());
        addType(MiscType.createCLLightActiveProbe());
        addType(MiscType.createISAPPod());
        addType(MiscType.createSword());
        addType(MiscType.createISPPCCapacitor());
        addType(MiscType.createRetractableBlade());
        addType(MiscType.createChainWhip());
        addType(MiscType.createISApolloFCS());
        addType(MiscType.createIMEjectionSeat());
        addType(MiscType.createSVEjectionSeat());
        addType(MiscType.createIndustrialTSM());
        addType(MiscType.createSalvageArm());
        addType(MiscType.createSpotWelder());
        addType(MiscType.createLiftHoist());
        addType(MiscType.createTracks());
        addType(MiscType.createQVWheels());
        addType(MiscType.createISMASS());
        addType(MiscType.createLightBridgeLayer());
        addType(MiscType.createMediumBridgeLayer());
        addType(MiscType.createHeavyBridgeLayer());

        // For industrials and tanks
        addType(MiscType.createCVEnvironmentalSealedChassis());
        addType(MiscType.createIndustrialMechEnvironmentalSealing());
        addType(MiscType.createFieldKitchen());

        addType(MiscType.createImprovedJumpJet());
        addType(MiscType.createVehicularJumpJet());
        addType(MiscType.createJumpBooster());
        addType(MiscType.createFerroFibrousPrototype());
        addType(MiscType.createFerroAlumPrototype());
        addType(MiscType.createLightFerroFibrous());
        addType(MiscType.createHeavyFerroFibrous());
        addType(MiscType.createISFerroAlum());
        addType(MiscType.createCLFerroAlum());
        addType(MiscType.createHeavyFerroAlum());
        addType(MiscType.createLightFerroAlum());
        addType(MiscType.createISHardenedArmor());
        addType(MiscType.createISIndustrialArmor());
        addType(MiscType.createISPrimitiveArmor());
        addType(MiscType.createPrimitiveFighterArmor());
        addType(MiscType.createISHeavyIndustrialArmor());
        addType(MiscType.createISCommercialArmor());
        addType(MiscType.createCLFerroLamellorArmor());
        addType(MiscType.createISEndoSteelPrototype());
        addType(MiscType.createReinforcedStructure());
        addType(MiscType.createISCompositeStructure());
        addType(MiscType.createIndustrialStructure());
        addType(MiscType.createIS1CompactHeatSink());
        addType(MiscType.createIS2CompactHeatSinks());
        addType(MiscType.createCLLaserHeatSink());
        addType(MiscType.createArtemisV());
        addType(MiscType.createISAngelECM());
        addType(MiscType.createISTHBAngelECM());
        addType(MiscType.createWatchdogECM());
        addType(MiscType.createMace());
        addType(MiscType.createDualSaw());
        addType(MiscType.createChainsaw());
        addType(MiscType.createRockCutter());
        addType(MiscType.createCombine());
        addType(MiscType.createBackhoe());
        addType(MiscType.createPileDriver());
        addType(MiscType.createArmoredCowl());
        addType(MiscType.createNullSignatureSystem());
        addType(MiscType.createVoidSignatureSystem());
        addType(MiscType.createChameleonLightPolarizationShield());
        addType(MiscType.createLightMinesweeper());
        addType(MiscType.createBridgeKit());
        addType(MiscType.createVibroShovel());
        addType(MiscType.createDemolitionCharge());
        addType(MiscType.createISSuperCharger());
        addType(MiscType.createCLSuperCharger());
        addType(MiscType.createISMediumShield());
        addType(MiscType.createISSmallShield());
        addType(MiscType.createISLargeShield());
        addType(MiscType.createISClaw());
        addType(MiscType.createISHarJel());
        addType(MiscType.createISUMU());
        addType(MiscType.createISLance());
        addType(MiscType.createISWreckingBall());
        addType(MiscType.createISFlail());
        addType(MiscType.createISMediumVibroblade());
        addType(MiscType.createISSmallVibroblade());
        addType(MiscType.createISLargeVibroblade());
        addType(MiscType.createISBuzzsaw());
        addType(MiscType.createHeavyArmor());
        addType(MiscType.createSpikes());
        addType(MiscType.createTalons());
        addType(MiscType.createISReactive());
        addType(MiscType.createCLReactive());
        addType(MiscType.createISReflective());
        addType(MiscType.createCLReflective());
        addType(MiscType.createISCASEII());
        addType(MiscType.createCLCASEII());
        addType(MiscType.createISAES());
        addType(MiscType.createISModularArmor());
        addType(MiscType.createCommsGear());
        addType(MiscType.createISGroundMobileHPG());
        addType(MiscType.createISMobileHPG());
        addType(MiscType.createISPartialWing());
        addType(MiscType.createCLPartialWing());
        addType(MiscType.createCargo());
        addType(MiscType.createLiquidCargo());
        addType(MiscType.createCargoContainer());
        addType(MiscType.createMechSprayer());
        addType(MiscType.createTankSprayer());
        addType(MiscType.createFrontDumper());
        addType(MiscType.createRearDumper());
        addType(MiscType.createLeftDumper());
        addType(MiscType.createRightDumper());
        addType(MiscType.createMASH());
        addType(MiscType.createParamedicEquipment());
        addType(MiscType.createISMastMount());
        addType(MiscType.createExtendedFuelTank());
        addType(MiscType.createBlueShield());
        addType(MiscType.createISEndoComposite());
        addType(MiscType.createClanEndoComposite());
        addType(MiscType.createISLaserInsulator());
        addType(MiscType.createISEWEquipment());
        addType(MiscType.createISCollapsibleCommandModule());
        addType(MiscType.createHitch());
        addType(MiscType.createISFlotationHull());
        addType(MiscType.createISLimitedAmphibiousChassis());
        addType(MiscType.createISFullyAmphibiousChassis());
        addType(MiscType.createISShoulderTurret());
        addType(MiscType.createISHeadTurret());
        addType(MiscType.createISQuadTurret());
        addType(MiscType.createISTankCommandConsole());
        addType(MiscType.createISSponsonTurret());
        addType(MiscType.createPintleTurret());
        addType(MiscType.createISArmoredMotiveSystem());
        addType(MiscType.createCLArmoredMotiveSystem());
        addType(MiscType.createISChaffPod());
        addType(MiscType.createBC3());
        addType(MiscType.createBC3i());
        addType(MiscType.createISHIResImager());
        addType(MiscType.createISHyperspectralImager());
        addType(MiscType.createISInfraredImager());
        addType(MiscType.createISLookDownRadar());
        addType(MiscType.createISVTOLJetBooster());
        addType(MiscType.createRemoteSensorDispenser());
        addType(MiscType.createPrototypeRemoteSensorDispenser());
        addType(MiscType.createISVehicularMineDispenser());
        addType(MiscType.createMiningDrill());
        addType(MiscType.createISReconCamera());
        addType(MiscType.createISCombatVehicleEscapePod());
        addType(MiscType.createISSmallNavalCommScannerSuite());
        addType(MiscType.createISLargeNavalCommScannerSuite());
        addType(MiscType.createISNavalTugAdaptor());
        addType(MiscType.createISSpaceMineDispenser());
        addType(MiscType.createVehicularStealth());
        addType(MiscType.createEmergencyC3M());
        addType(MiscType.createNovaCEWS());

        // ProtoMek Stuff
        addType(MiscType.createCLProtoMyomerBooster());
        addType(MiscType.createProtoPartialWing());
        addType(MiscType.createProtomechJumpJet());
        addType(MiscType.createExtendedJumpJet());
        addType(MiscType.createProtomechUMU());

        // Start BattleArmor equipment
        addType(MiscType.createISBAStandardArmor());
        addType(MiscType.createClanBAStandardArmor());
        addType(MiscType.createISBAAdvancedArmor());
        addType(MiscType.createISBAStandardPrototypeArmor());
        addType(MiscType.createClanBAFireResistantArmor());
        addType(MiscType.createISBAReactiveArmor());
        addType(MiscType.createClanBAReactiveArmor());
        addType(MiscType.createISBAReflectiveArmor());
        addType(MiscType.createClanBAReflectiveArmor());
        addType(MiscType.createISBAStealthPrototype());
        addType(MiscType.createISBABasicStealth());
        addType(MiscType.createClanBABasicStealth());
        addType(MiscType.createISBAStandardStealth());
        addType(MiscType.createClanBAStandardStealth());
        addType(MiscType.createISBAImprovedStealth());
        addType(MiscType.createClanBAImprovedStealth());
        addType(MiscType.createISBAMimeticCamo());
        addType(MiscType.createMine());
        addType(MiscType.createBABasicManipulator());
        addType(MiscType.createBABasicManipulatorMineClearance());
        addType(MiscType.createBABattleClaw());
        addType(MiscType.createBABattleClawMagnets());
        addType(MiscType.createBABattleClawVibro());
        addType(MiscType.createBACargoLifter());
        addType(MiscType.createBAHeavyBattleClaw());
        addType(MiscType.createBAHeavyBattleClawMagnet());
        addType(MiscType.createBAHeavyBattleClawVibro());
        addType(MiscType.createBAIndustrialDrill());
        addType(MiscType.createBASalvageArm());
        addType(MiscType.createBAModularEquipmentAdaptor());
        addType(MiscType.createBAArmoredGlove());
        addType(MiscType.createBAMagneticClamp());
        addType(MiscType.createBAAPMount());
        addType(MiscType.createCLBAMyomerBooster());
        addType(MiscType.createISSingleHexECM());
        addType(MiscType.createCLSingleHexECM());
        addType(MiscType.createBattleMechNeuralInterfaceUnit());
        addType(MiscType.createBAISAngelECM());
        addType(MiscType.createBACLAngelECM());
        addType(MiscType.createSimpleCamo());
        addType(MiscType.createParafoil());
        addType(MiscType.createSearchlight());
        addType(MiscType.createBASearchlight());
        addType(MiscType.createHandheldSearchlight());
        addType(MiscType.createISImprovedSensors());
        addType(MiscType.createCLImprovedSensors());
        addType(MiscType.createISBALightActiveProbe());
        addType(MiscType.createISBARemoteSensorDispenser());
        addType(MiscType.createBACuttingTorch());
        addType(MiscType.createISBASpaceOperationsAdaptation());
        addType(MiscType.createISDetachableWeaponPack());
        addType(MiscType.createISBAHeatSensor());
        addType(MiscType.createISBAExtendedLifeSupport());
        addType(MiscType.createBAPartialWing());
        addType(MiscType.createBAJumpJet());
        addType(MiscType.createBAVTOLEquipment());
        addType(MiscType.createBAUMU());
        addType(MiscType.createISBAJumpBooster());
        addType(MiscType.createISBAMechanicalJumpBooster());
        addType(MiscType.createISBAFuelTank());
        addType(MiscType.createBALaserMicrophone());
        addType(MiscType.createBAPowerPack());
        addType(MiscType.createBAShotgunMicrophone());
        addType(MiscType.createISBAMineDispenser());
        addType(MiscType.createBAMissionEquipStorage());
        addType(MiscType.createISBADropChuteCamo());
        addType(MiscType.createISBADropChuteCamo());
        addType(MiscType.createISBADropChuteStd());
        addType(MiscType.createISBADropChuteStealth());
        addType(MiscType.createVeeDropChuteCamo());
        addType(MiscType.createVeeDropChuteReuse());
        addType(MiscType.createVeeDropChuteStd());
        addType(MiscType.createVeeDropChuteStealth());
        ...
        addType(MiscType.createAmphibiousChassis());
        addType(MiscType.createArmoredChassis());
        addType(MiscType.createBicycleModification());
        addType(MiscType.createConvertibleModification());
        addType(MiscType.createISCVDuneBuggyChassis());
        addType(MiscType.createEnvironmentalSealingChassisMod());
        addType(MiscType.createExternalPowerPickup());
        addType(MiscType.createHydroFoilChassisModification());
        addType(MiscType.createMonocycleModification());
        addType(MiscType.createISOffRoadChassis());
        addType(MiscType.createOmniChassisMod());
        addType(MiscType.createPropChassisModification());
        addType(MiscType.createSnomobileChassis());
        addType(MiscType.createSTOLChassisMod());
        addType(MiscType.createSubmersibleChassisMod());
        addType(MiscType.createTractorModification());
        addType(MiscType.createTrailerModification());
        addType(MiscType.createUltraLightChassisModification());
        addType(MiscType.createVSTOLChassisMod());
        addType(MiscType.createISSVDuneBuggyChassis());

        // Support Vee Equipment stuff
        addType(MiscType.createBasicFireControl());
        addType(MiscType.createAdvancedFireControl());
        addType(MiscType.createISMineSweeper());
        addType(MiscType.createISMobileFieldBase());
        addType(MiscType.createISPrototypeJumpJet());
        addType(MiscType.createISPrototypeImprovedJumpJet());
        addType(MiscType.createBoobyTrap());
        addType(MiscType.createRefuelingDrogue());
        addType(MiscType.createBulldozer());
        addType(MiscType.createExternalStoresHardpoint());
        addType(MiscType.createManipulator());
        addType(MiscType.createLadder());
        addType(MiscType.createMaritimeLifeboat());
        addType(MiscType.createMaritimeEscapePod());
        addType(MiscType.createAtmossphericLifeboat());

        // 3145 Stuff
        addType(MiscType.createAntiPenetrativeAblation());
        addType(MiscType.createISHeatDissipating());
        addType(MiscType.createISImpactResistant());
        addType(MiscType.createISBallisticReinforced());
        addType(MiscType.createHarJelII());
        addType(MiscType.createHarJelIII());
        addType(MiscType.createRadicalHeatSinkSystem());
        addType(MiscType.createLAMBombBay());
        addType(MiscType.createLightFluidSuctionSystemMech());
        addType(MiscType.createLightFluidSuctionSystem());
        addType(MiscType.createFluidSuctionSystem());
        addType(MiscType.createRISCSuperCooledMyomer());
        addType(MiscType.createRISCViralJammerDecoy());
        addType(MiscType.createRISCViralJammerHoming());
        addType(MiscType.createRISCLaserPulseModule());
        addType(MiscType.createRISCEmergencyCoolantSystem());

        // Prototype Stuff
        addType(MiscType.createISProtoArtemis());
        addType(MiscType.createCASEPrototype());
        addType(MiscType.createElectricDischargeArmor());
        addType(MiscType.createProtoMagneticClamp());
        addType(MiscType.createProtomechMeleeWeapon());
        addType(MiscType.createProtoQuadMeleeSystem());

        // Drone and Robotic Systems
        addType(MiscType.createISRemoteDroneCommandConsole());
        addType(MiscType.createSmartRoboticControlSystem());
        addType(MiscType.createImprovedSmartRoboticControlSystem());
        addType(MiscType.createISDroneCarrierControlSystem());
        addType(MiscType.createISDroneOperatingSystem());
        addType(MiscType.createShieldedAeroSRCS());
        addType(MiscType.createImprovedShieldedAeroSRCS());
        addType(MiscType.createEliteShieldedAeroSRCS());
        addType(MiscType.createCasparDroneControlSystem());
        addType(MiscType.createImprovedCasparDroneControlSystem());
        addType(MiscType.createCasparIIDroneControlSystem());
        addType(MiscType.createImprovedCasparIIDroneControlSystem());
        addType(MiscType.createAutoTacticalAnalysisComputer());
        addType(MiscType.createAdvRoboticTransportSystem());
        addType(MiscType.createDirectTacticalAnalysisSystem());
        addType(MiscType.createSDSSelfDestructSystem());
        addType(MiscType.createSDSJammerSystem());

        // Large Craft Systems
        addType(MiscType.createPCMT());
        addType(MiscType.createLithiumFusionBattery());
        addType(MiscType.createLightSail());
        addType(MiscType.createEnergyStorageBattery());
        addType(MiscType.createISImpFerroAluminumArmor());
        addType(MiscType.createClanImpFerroAluminumArmor());
        addType(MiscType.createPrimitiveLCAerospaceArmor());
        addType(MiscType.createISAeroSpaceArmor());
        addType(MiscType.createClanAeroSpaceArmor());
        addType(MiscType.createISFerroCarbideArmor());
        addType(MiscType.createClanFerroCarbideArmor());
        addType(MiscType.createISLamellorFerroCarbideArmor());
        addType(MiscType.createClanLamellorFerroCarbideArmor());

        // Infantry Equipment Packs
        addType(MiscType.createISAblativeStandardInfArmor());
        addType(MiscType.createISAblativeConcealedInfArmor());
        addType(MiscType.createISAblativeFlakStandardArmorInfArmor());
        addType(MiscType.createISAblativeFlakConcealedArmorInfArmor());
        addType(MiscType.createISBallisicPlateStandardInfArmor());
        addType(MiscType.createBallisicPlateConcealedInfArmor());
        addType(MiscType.createClothingFatiguesInfArmor());
        addType(MiscType.createClothingLeatherHideInfArmor());
        addType(MiscType.createClothingLightInfArmor());
        addType(MiscType.createISEngineeringSuitInfArmor());
        addType(MiscType.createISEnvironmentSuitLightInfArmor());
        addType(MiscType.createISEnvironmentSuitHostileInfArmor());
        addType(MiscType.createISEnvironmentSuitMarineInfArmor());
        addType(MiscType.createISFlakStandardInfArmor());
        addType(MiscType.createISFlakConcealedInfArmor());
        addType(MiscType.createISHeatSuitInfArmor());
        addType(MiscType.createISMechWarriorCombatSuitInfArmor());
        addType(MiscType.createISMechWarriorCoolingSuitInfArmor());
        addType(MiscType.createMechWarriorCoolingVestInfArmor());
        addType(MiscType.createMyomerSuitInfArmor());
        addType(MiscType.createMyomerVestInfArmor());
        addType(MiscType.createParkaInfArmor());
        addType(MiscType.createNeoChainMailInfArmor());
        addType(MiscType.createSnowSuitInfArmor());
        addType(MiscType.createSpaceSuitInfArmor());
        addType(MiscType.createSpacesuitCombatInfArmor());
        addType(MiscType.createCapellanConfederationInfArmor());
        addType(MiscType.createClanInfArmor());
        addType(MiscType.createComstarInfArmor());
        addType(MiscType.createDraconisCombineInfArmor());
        addType(MiscType.createFedSunsInfArmor());
        addType(MiscType.createFedComInfArmor());
        addType(MiscType.createFedSunsLateInfArmor());
        addType(MiscType.createFRRInfArmor());
        addType(MiscType.createFWLEarlyInfArmor());
        addType(MiscType.createFWLLateInfArmor());
        addType(MiscType.createLyranInfArmor());
        addType(MiscType.createLyranLateInfArmor());
        addType(MiscType.createCanopusInfArmor());
        addType(MiscType.createMarianInfArmor());
        addType(MiscType.createTaurianInfArmor());
        addType(MiscType.createWoBInfArmor());
        addType(MiscType.createGenericInfArmor());
        addType(MiscType.createISSLDFInfArmor());
        addType(MiscType.createDESTInfArmor());
        addType(MiscType.createISSneakCamoSystemInfArmor());
        addType(MiscType.createISSneakIRSystemInfArmor());
        addType(MiscType.createISSneakECMSystemInfArmor());
        addType(MiscType.createISSneakCamoIRInfArmor());
        addType(MiscType.createISSneakCamoECMInfArmor());
        addType(MiscType.createISSneakIRECMInfArmor());
        addType(MiscType.createISSneakThreeSystemInfArmor());
    ...
    public static MiscType createISCommercialArmor() {
        ...
        misc.name = getArmorTypeName(T_ARMOR_COMMERCIAL);
        misc.setInternalName(getArmorTypeName(T_ARMOR_COMMERCIAL, false));
        misc.setInternalName(getArmorTypeName(T_ARMOR_COMMERCIAL, true));
        misc.tonnage = TONNAGE_VARIABLE;
        misc.criticals = 0;
        misc.hittable = false;
        misc.bv = 0;
    ...
    public static MiscType createISPrimitiveArmor() {
        ...
        misc.name = getArmorTypeName(T_ARMOR_PRIMITIVE);
        misc.setInternalName(getArmorTypeName(T_ARMOR_PRIMITIVE, false));
        misc.tonnage = TONNAGE_VARIABLE;
        misc.criticals = 0;
        misc.hittable = false;
        misc.bv = 0;
    ...
    public static MiscType createPrimitiveFighterArmor() {
        ...
        misc.name = getArmorTypeName(T_ARMOR_PRIMITIVE_FIGHTER);
        misc.setInternalName(getArmorTypeName(T_ARMOR_PRIMITIVE_FIGHTER, false));
        misc.tonnage = TONNAGE_VARIABLE;
        misc.criticals = 0;
        misc.hittable = false;
        misc.bv = 0;
    ...
    public static MiscType createISIndustrialArmor() {
        ...
        misc.name = getArmorTypeName(T_ARMOR_INDUSTRIAL);
        misc.setInternalName(getArmorTypeName(T_ARMOR_INDUSTRIAL, false));
        misc.setInternalName(getArmorTypeName(T_ARMOR_INDUSTRIAL, true));
    ...
    public static MiscType createStandard() {
        ...
        misc.name = getStructureTypeName(T_STRUCTURE_STANDARD);
        misc.setInternalName(getStructureTypeName(T_STRUCTURE_STANDARD));
        misc.addLookupName(getStructureTypeName(T_STRUCTURE_STANDARD, false));
        misc.addLookupName(getStructureTypeName(T_STRUCTURE_STANDARD, true));
        misc.addLookupName(getArmorTypeName(T_ARMOR_STANDARD, false));
        misc.addLookupName(getArmorTypeName(T_ARMOR_STANDARD, true));
    ...
    public static MiscType createISHeavyIndustrialArmor() {
        ...
        misc.name = getArmorTypeName(T_ARMOR_HEAVY_INDUSTRIAL);
        misc.setInternalName(getArmorTypeName(T_ARMOR_HEAVY_INDUSTRIAL, false));
        misc.addLookupName(getArmorTypeName(T_ARMOR_HEAVY_INDUSTRIAL, true));
        misc.tonnage = TONNAGE_VARIABLE;
        misc.criticals = 0;
        misc.hittable = false;
        misc.bv = 0;
    ...
    public static MiscType createAntiPenetrativeAblation() {
        MiscType misc = new MiscType();
        misc.name = getArmorTypeName(T_ARMOR_ANTI_PENETRATIVE_ABLATION);
    ...
    public static MiscType createISBallisticReinforced() {
        MiscType misc = new MiscType();
        misc.name = getArmorTypeName(T_ARMOR_BALLISTIC_REINFORCED);
        misc.setInternalName("IS " + misc.name);
        misc.tonnage = TONNAGE_VARIABLE;
        misc.criticals = CRITICALS_VARIABLE;
        misc.hittable = false;
    ...
    public static MiscType createFerroFibrousPrototype() {
        ...
        misc.name = getArmorTypeName(T_ARMOR_FERRO_FIBROUS_PROTO);
        misc.setInternalName(getArmorTypeName(T_ARMOR_FERRO_FIBROUS_PROTO, false));
    ...
    public static MiscType createISFerroFibrous() {
        MiscType misc = new MiscType();
        misc.name = getArmorTypeName(T_ARMOR_FERRO_FIBROUS);
        misc.setInternalName(getArmorTypeName(T_ARMOR_FERRO_FIBROUS, false));
    ...
    public static MiscType createFerroAlumPrototype() {
        ...
        misc.name = getArmorTypeName(T_ARMOR_FERRO_ALUM_PROTO);
        misc.setInternalName(getArmorTypeName(T_ARMOR_FERRO_ALUM_PROTO, false));
    ...
    public static MiscType createISFerroAlum() {
        ...
        misc.name = getArmorTypeName(T_ARMOR_ALUM);
        misc.setInternalName(getArmorTypeName(T_ARMOR_ALUM, false));
    ...
    public static MiscType createCLFerroAlum() {
        ...
        misc.name = getArmorTypeName(T_ARMOR_ALUM);
        misc.setInternalName(getArmorTypeName(T_ARMOR_ALUM, true));
    ...
    public static MiscType createCLFerroFibrous() {
        MiscType misc = new MiscType();
        misc.name = getArmorTypeName(T_ARMOR_FERRO_FIBROUS);
        misc.setInternalName(getArmorTypeName(T_ARMOR_FERRO_FIBROUS, true));
    ...
    public static MiscType createLightFerroFibrous() {
        ...
        misc.name = getArmorTypeName(T_ARMOR_LIGHT_FERRO);
        misc.setInternalName(getArmorTypeName(T_ARMOR_LIGHT_FERRO, false));
    ...
    public static MiscType createLightFerroAlum() {
        ...
        misc.name = getArmorTypeName(T_ARMOR_LIGHT_ALUM);
        misc.setInternalName(getArmorTypeName(T_ARMOR_LIGHT_ALUM, false));
    ...
    public static MiscType createHeavyFerroFibrous() {
        ...
        misc.name = getArmorTypeName(T_ARMOR_HEAVY_FERRO);
        misc.setInternalName(getArmorTypeName(T_ARMOR_HEAVY_FERRO, false));
    ...
    public static MiscType createHeavyFerroAlum() {
        ...
        misc.name = getArmorTypeName(T_ARMOR_HEAVY_ALUM);
        misc.setInternalName(getArmorTypeName(T_ARMOR_HEAVY_ALUM, false));
    ...
    public static MiscType createCLFerroLamellorArmor() {
        ...
        misc.name = getArmorTypeName(T_ARMOR_FERRO_LAMELLOR);
        misc.setInternalName(getArmorTypeName(T_ARMOR_FERRO_LAMELLOR, true));
        misc.tonnage = TONNAGE_VARIABLE;
        misc.criticals = CRITICALS_VARIABLE;
        misc.hittable = false;
        misc.spreadable = true;
    ...
    public static MiscType createISHardenedArmor() {
        ...
        misc.name = getArmorTypeName(T_ARMOR_HARDENED);
        misc.setInternalName(getArmorTypeName(T_ARMOR_HARDENED, false));
    ...
    public static MiscType createISHeatDissipating() {
        MiscType misc = new MiscType();
        misc.name = getArmorTypeName(T_ARMOR_HEAT_DISSIPATING);
        misc.setInternalName("IS " + misc.name);
    ...
    public static MiscType createISImpactResistant() {
        MiscType misc = new MiscType();
        misc.name = getArmorTypeName(T_ARMOR_IMPACT_RESISTANT);
        misc.setInternalName("IS " + misc.name);
        misc.tonnage = TONNAGE_VARIABLE;
        misc.criticals = CRITICALS_VARIABLE;
        misc.hittable = false;
    ...
    public static MiscType createISReflective() {
        ...
        misc.name = getArmorTypeName(T_ARMOR_REFLECTIVE);
        misc.setInternalName(getArmorTypeName(T_ARMOR_REFLECTIVE, false));
    ...
    public static MiscType createCLReflective() {
        ...
        misc.name = getArmorTypeName(T_ARMOR_REFLECTIVE);
        misc.setInternalName(getArmorTypeName(T_ARMOR_REFLECTIVE, true));
    ...
    public static MiscType createISReactive() {
        ...
        misc.name = getArmorTypeName(T_ARMOR_REACTIVE);
        misc.setInternalName(getArmorTypeName(T_ARMOR_REACTIVE, false));
    ...
    public static MiscType createCLReactive() {
        ...
        misc.name = getArmorTypeName(T_ARMOR_REACTIVE);
        misc.setInternalName(getArmorTypeName(T_ARMOR_REACTIVE, true));
    ...
    public static MiscType createMekStealth() {
        ...
        misc.name = getArmorTypeName(T_ARMOR_STEALTH);
        misc.setInternalName(getArmorTypeName(T_ARMOR_STEALTH, false));
    ...
    public static MiscType createVehicularStealth() {
        ...
        misc.name = getArmorTypeName(T_ARMOR_STEALTH_VEHICLE);
        misc.setInternalName(getArmorTypeName(T_ARMOR_STEALTH_VEHICLE, false));
    ...
    public static MiscType createPrimitiveLCAerospaceArmor() {
        ...
        misc.name = getArmorTypeName(T_ARMOR_PRIMITIVE_AERO);
        misc.setInternalName(getArmorTypeName(T_ARMOR_PRIMITIVE_AERO, false));
        misc.tonnage = TONNAGE_VARIABLE;
        misc.criticals = 0;
        misc.hittable = false;
        misc.bv = 0;
    ...
    public static MiscType createISAeroSpaceArmor() {
        ...
        misc.name = getArmorTypeName(T_ARMOR_AEROSPACE);
        misc.setInternalName(getArmorTypeName(T_ARMOR_AEROSPACE, false));
        misc.tonnage = 0;
        misc.criticals = 0;
        misc.hittable = false;
        misc.spreadable = true;
    ...
    public static MiscType createClanAeroSpaceArmor() {
        ...
        misc.name = getArmorTypeName(T_ARMOR_AEROSPACE);
        misc.setInternalName(getArmorTypeName(T_ARMOR_AEROSPACE, true));
        misc.tonnage = 0;
        misc.criticals = 0;
        misc.hittable = false;
        misc.spreadable = true;
    ...
    public static MiscType createISImpFerroAluminumArmor() {
        ...
        misc.name = getArmorTypeName(T_ARMOR_LC_FERRO_IMP);
        misc.setInternalName(getArmorTypeName(T_ARMOR_LC_FERRO_IMP, false));
        misc.addLookupName(misc.name);
    ...
    public static MiscType createClanImpFerroAluminumArmor() {
        ...
        misc.name = getArmorTypeName(T_ARMOR_LC_FERRO_IMP);
        misc.setInternalName(getArmorTypeName(T_ARMOR_LC_FERRO_IMP, true));
        misc.tonnage = 0;
        misc.criticals = 0;
        misc.hittable = false;
        misc.bv = 0;
    ...
    public static MiscType createISFerroCarbideArmor() {
        ...
        misc.name = getArmorTypeName(T_ARMOR_LC_FERRO_CARBIDE);
        misc.setInternalName(getArmorTypeName(T_ARMOR_LC_FERRO_CARBIDE, false));
    ...
    public static MiscType createClanFerroCarbideArmor() {
        ...
        misc.name = getArmorTypeName(T_ARMOR_LC_FERRO_CARBIDE);
        misc.setInternalName(getArmorTypeName(T_ARMOR_LC_FERRO_CARBIDE, true));
        misc.tonnage = 0;
        misc.criticals = 0;
        misc.hittable = false;
        misc.bv = 0;
    ...
    public static MiscType createISLamellorFerroCarbideArmor() {
        ...
        misc.name = getArmorTypeName(T_ARMOR_LC_LAMELLOR_FERRO_CARBIDE);
        misc.setInternalName(getArmorTypeName(T_ARMOR_LC_LAMELLOR_FERRO_CARBIDE, false));
        misc.addLookupName(misc.name);
        misc.tonnage = 0;
        misc.criticals = 0;
        misc.hittable = false;
    ...
    public static MiscType createClanLamellorFerroCarbideArmor() {
        ...
        misc.name = getArmorTypeName(T_ARMOR_LC_LAMELLOR_FERRO_CARBIDE);
        misc.setInternalName(getArmorTypeName(T_ARMOR_LC_LAMELLOR_FERRO_CARBIDE, true));
        misc.tonnage = 0;
        misc.criticals = 0;
        misc.hittable = false;
        misc.spreadable = true;
    ...
    public static MiscType createElectricDischargeArmor() {
        ...
        MiscType misc = new MiscType();
        misc.name = getArmorTypeName(T_ARMOR_EDP);
        misc.setInternalName("CLEDPArmor");
        misc.addLookupName(getArmorTypeName(T_ARMOR_EDP, true));
        misc.addLookupName(getArmorTypeName(T_ARMOR_EDP));
        misc.shortName = "EDP";
        misc.tonnage = TONNAGE_VARIABLE;
        misc.hittable = false;
    ...
    public static MiscType createISBAStandardArmor() {
        ...
        misc.name = getArmorTypeName(T_ARMOR_BA_STANDARD);
        misc.setInternalName(getArmorTypeName(T_ARMOR_BA_STANDARD, false));
    ...
    public static MiscType createClanBAStandardArmor() {
        ...
        misc.name = getArmorTypeName(T_ARMOR_BA_STANDARD);
        misc.setInternalName(getArmorTypeName(T_ARMOR_BA_STANDARD, true));
    ...
    public static MiscType createISBAStandardPrototypeArmor() {
        ...
        misc.setInternalName(getArmorTypeName(T_ARMOR_BA_STANDARD_PROTOTYPE));
    ...
    public static MiscType createISBAAdvancedArmor() {
        ...
        misc.setInternalName(getArmorTypeName(T_ARMOR_BA_STANDARD_ADVANCED));
    ...
    public static MiscType createClanBAFireResistantArmor() {
        ...
        misc.setInternalName(getArmorTypeName(T_ARMOR_BA_FIRE_RESIST));
    ...
    public static MiscType createISBAStealthPrototype() {
        ...
        misc.setInternalName(getArmorTypeName(T_ARMOR_BA_STEALTH_PROTOTYPE));
    ...
    public static MiscType createISBABasicStealth() {
        ...
        misc.setInternalName(getArmorTypeName(T_ARMOR_BA_STEALTH_BASIC, false));
    ...
    public static MiscType createClanBABasicStealth() {
        ...
        misc.name = BattleArmor.BASIC_STEALTH_ARMOR;
        misc.setInternalName(getArmorTypeName(T_ARMOR_BA_STEALTH_BASIC, true));
    ...
    public static MiscType createISBAStandardStealth() {
        ...
        misc.setInternalName(getArmorTypeName(T_ARMOR_BA_STEALTH, false));
    ...
    public static MiscType createClanBAStandardStealth() {
        ...
        misc.name = BattleArmor.STANDARD_STEALTH_ARMOR;
        misc.setInternalName(getArmorTypeName(T_ARMOR_BA_STEALTH, true));
    ...
    public static MiscType createISBAImprovedStealth() {
        ...
        misc.setInternalName(getArmorTypeName(T_ARMOR_BA_STEALTH_IMP, false));
    ...
    public static MiscType createClanBAImprovedStealth() {
        MiscType misc = new MiscType();
        misc.name = BattleArmor.IMPROVED_STEALTH_ARMOR;
        misc.setInternalName(getArmorTypeName(T_ARMOR_BA_STEALTH_IMP, true));
    ...
    public static MiscType createISBAMimeticCamo() {
        ...
        misc.setInternalName(getArmorTypeName(T_ARMOR_BA_MIMETIC));
    ...
    public static MiscType createISBAReactiveArmor() {
        MiscType misc = new MiscType();
        misc.name = getArmorTypeName(T_ARMOR_BA_REACTIVE);
        misc.setInternalName(getArmorTypeName(T_ARMOR_BA_REACTIVE, false));
    ...
    public static MiscType createClanBAReactiveArmor() {
        MiscType misc = new MiscType();
        misc.name = getArmorTypeName(T_ARMOR_BA_REACTIVE);
        misc.setInternalName(getArmorTypeName(T_ARMOR_BA_REACTIVE, true));
    ...
    public static MiscType createISBAReflectiveArmor() {
        ...
        misc.name = getArmorTypeName(T_ARMOR_BA_REFLECTIVE);
        misc.setInternalName(getArmorTypeName(T_ARMOR_BA_REFLECTIVE, false));
    ...
    public static MiscType createClanBAReflectiveArmor() {
        ...
        misc.name = getArmorTypeName(T_ARMOR_BA_REFLECTIVE);
        misc.setInternalName(getArmorTypeName(T_ARMOR_BA_REFLECTIVE, true));
    ...
    public static MiscType createC3S() {
        ...
        misc.criticals = 1;
        misc.cost = 250000;
        misc.flags = misc.flags.or(F_C3S).or(F_MECH_EQUIPMENT).or(F_TANK_EQUIPMENT).or(F_SUPPORT_TANK_EQUIPMENT).andNot(F_FIGHTER_EQUIPMENT);
        misc.bv = 0;
    ...
    public static MiscType createC3SBS() {
        ...
        misc.criticals = 2;
        misc.cost = 500000;
        misc.flags = misc.flags.or(F_C3SBS).or(F_MECH_EQUIPMENT).or(F_TANK_EQUIPMENT).or(F_SUPPORT_TANK_EQUIPMENT).andNot(F_FIGHTER_EQUIPMENT);
        misc.bv = 0;
    ...
    public static MiscType createEmergencyC3M() {
        ...
        misc.flags = misc.flags.or(F_C3EM).or(F_MECH_EQUIPMENT).or(F_TANK_EQUIPMENT).or(F_SUPPORT_TANK_EQUIPMENT).or(F_C3S).andNot(F_FIGHTER_EQUIPMENT);
        misc.bv = 0;
        misc.rulesRefs = "298,TO";
        misc.techAdvancement.setTechBase(TECH_BASE_IS).setIntroLevel(false).setUnofficial(false).setTechRating(RATING_E)
                .setAvailability(RATING_X, RATING_X, RATING_F, RATING_E)
    ...
    public static MiscType createISCASE() {
        ...
        misc.criticals = 1;
        misc.hittable = false;
        misc.flags = misc.flags.or(F_CASE).or(F_MECH_EQUIPMENT).or(F_TANK_EQUIPMENT).or(F_SUPPORT_TANK_EQUIPMENT).or(F_FIGHTER_EQUIPMENT);
        misc.cost = 50000;
        misc.bv = 0;
    ...
    public static MiscType createCASEPrototype() {
        ...
        misc.criticals = 1;
        misc.hittable = false;
        misc.flags = misc.flags.or(F_CASEP).or(F_MECH_EQUIPMENT).or(F_TANK_EQUIPMENT).or(F_SUPPORT_TANK_EQUIPMENT).or(F_FIGHTER_EQUIPMENT);
        misc.cost = 150000;
        misc.bv = 0;
    ...
    public static MiscType createISAPPod() {
        ...
        misc.flags = misc.flags.or(F_AP_POD).or(F_MECH_EQUIPMENT).or(F_TANK_EQUIPMENT)
                .or(F_SUPPORT_TANK_EQUIPMENT).andNot(F_FIGHTER_EQUIPMENT);
        misc.bv = 1;
    ...
    public static MiscType createISAngelECM() {
		...
		misc.flags = misc.flags.or(F_ECM).or(F_ANGEL_ECM).or(F_MECH_EQUIPMENT).or(F_TANK_EQUIPMENT).or(F_SUPPORT_TANK_EQUIPMENT)
				...
				.andNot(F_WS_EQUIPMENT).andNot(F_JS_EQUIPMENT).andNot(F_SS_EQUIPMENT);
		misc.bv = 100;
        misc.setModes(new String[] { "ECM" });
        misc.setInstantModeSwitch(false);
        misc.rulesRefs = "279,TO";
    ...
    public static MiscType createISProtoArtemis() {
        ...
        misc.criticals = 1;
        misc.cost = 100000;
        misc.flags = misc.flags.or(F_ARTEMIS_PROTO).or(F_MECH_EQUIPMENT).or(F_TANK_EQUIPMENT).or(F_SUPPORT_TANK_EQUIPMENT)
    ...
    public static MiscType createISTargComp() {
        ...
        misc.flags = misc.flags.or(F_TARGCOMP).or(F_MECH_EQUIPMENT).or(F_TANK_EQUIPMENT).or(F_SUPPORT_TANK_EQUIPMENT).or(F_FIGHTER_EQUIPMENT);
        // see note above
        misc.spreadable = true;
    ...
    public static MiscType createISMobileFieldBase() {
        ...
        misc.tonnage = 20;
        misc.cost = 150000;
        misc.flags = misc.flags.or(F_MOBILE_FIELD_BASE).or(F_TANK_EQUIPMENT).or(F_SUPPORT_TANK_EQUIPMENT).or(F_DS_EQUIPMENT).or(F_JS_EQUIPMENT).or(F_WS_EQUIPMENT)
                .or(F_SS_EQUIPMENT);
        misc.bv = 0;
        misc.rulesRefs = "330,TO";
        misc.techAdvancement.setTechBase(TECH_BASE_ALL).setIntroLevel(false).setUnofficial(false)
    ...
    public static MiscType createRISCLaserPulseModule() {
        ...
        misc.flags = misc.flags.or(F_RISC_LASER_PULSE_MODULE).or(F_MECH_EQUIPMENT).or(F_TANK_EQUIPMENT).or(F_SUPPORT_TANK_EQUIPMENT)
                .or(F_FIGHTER_EQUIPMENT).or(F_SC_EQUIPMENT).or(F_DS_EQUIPMENT).or(F_JS_EQUIPMENT).or(F_WS_EQUIPMENT).or(F_SS_EQUIPMENT).or(F_VTOL_EQUIPMENT).or(F_PROTOMECH_EQUIPMENT);
        misc.explosive = true;
    ...
    public static MiscType createISEndoSteel() {
        ...
        misc.name = getStructureTypeName(T_STRUCTURE_ENDO_STEEL);
        misc.setInternalName(getStructureTypeName(T_STRUCTURE_ENDO_STEEL, false));
    ...
    public static MiscType createISEndoSteelPrototype() {
        ...
        misc.name = getStructureTypeName(T_STRUCTURE_ENDO_PROTOTYPE);
        misc.setInternalName(getStructureTypeName(T_STRUCTURE_ENDO_PROTOTYPE, false));
    ...
    public static MiscType createCLEndoSteel() {
        MiscType misc = new MiscType();
        misc.name = getStructureTypeName(T_STRUCTURE_ENDO_STEEL);
        misc.setInternalName(getStructureTypeName(T_STRUCTURE_ENDO_STEEL, true));
    ...
    public static MiscType createISCompositeStructure() {
        ...
        misc.name = getStructureTypeName(T_STRUCTURE_COMPOSITE);
        misc.setInternalName(getStructureTypeName(T_STRUCTURE_COMPOSITE, false));
    ...
    public static MiscType createISEndoComposite() {
        ...
        misc.name = getStructureTypeName(T_STRUCTURE_ENDO_COMPOSITE);
        misc.setInternalName(getStructureTypeName(T_STRUCTURE_ENDO_COMPOSITE, false));
    ...
    public static MiscType createClanEndoComposite() {
        ...
        misc.name = getStructureTypeName(T_STRUCTURE_ENDO_COMPOSITE);
        misc.setInternalName(getStructureTypeName(T_STRUCTURE_ENDO_COMPOSITE, true));
    ...
    public static MiscType createReinforcedStructure() {
        ...
        misc.name = getStructureTypeName(T_STRUCTURE_REINFORCED);
        misc.setInternalName(getStructureTypeName(T_STRUCTURE_REINFORCED));
    ...
    public static MiscType createIndustrialStructure() {
        ...
        misc.name = getStructureTypeName(T_STRUCTURE_INDUSTRIAL);
        misc.setInternalName(getStructureTypeName(T_STRUCTURE_INDUSTRIAL));
        misc.addLookupName(getStructureTypeName(T_STRUCTURE_INDUSTRIAL, false));
        misc.addLookupName(getStructureTypeName(T_STRUCTURE_INDUSTRIAL, true));
