 ...
 *  for more details.
 */
package org.redbat.roguetech.megamek.common.loaders;

import org.redbat.roguetech.megamek.common.*;
import org.redbat.roguetech.megamek.utils.MegaMekXmlUtil;
    ...
    public Entity getEntity() throws EntityLoadingException {
        try {
            ...
            if ((mech.isClan() && !mech.isMixedTech())
                ...
                engineFlags = org.redbat.roguetech.megamek.common.Engine.CLAN_ENGINE;
            }
            mech.setEngine(new org.redbat.roguetech.megamek.common.Engine(basics.structure.engine.engineRating,
                    org.redbat.roguetech.megamek.common.Engine.getEngineTypeByString(basics.structure.engine.engineType), engineFlags));
    ...
    private void parseCrits(Mech mech, int loc) throws EntityLoadingException {
        ...
        for (int i = 0; i < mech.getNumberOfCriticals(loc); i++) {
            ...
            if (crit.content.contains("Engine")) {
                mech.setCritical(loc, i, new org.redbat.roguetech.megamek.common.CriticalSlot(
                        org.redbat.roguetech.megamek.common.CriticalSlot.TYPE_SYSTEM, Mech.SYSTEM_ENGINE));
                continue;
            }
            if (crit.content.contains("Gyro")) {
                mech.setCritical(loc, i, new org.redbat.roguetech.megamek.common.CriticalSlot(
                        org.redbat.roguetech.megamek.common.CriticalSlot.TYPE_SYSTEM, Mech.SYSTEM_GYRO));
                continue;
            }
            if (crit.content.contains("Life Support")) {
                mech.setCritical(loc, i, new org.redbat.roguetech.megamek.common.CriticalSlot(
                        org.redbat.roguetech.megamek.common.CriticalSlot.TYPE_SYSTEM, Mech.SYSTEM_LIFE_SUPPORT));
                continue;
            }
            if (crit.content.contains("Sensors")) {
                mech.setCritical(loc, i, new org.redbat.roguetech.megamek.common.CriticalSlot(
                        org.redbat.roguetech.megamek.common.CriticalSlot.TYPE_SYSTEM, Mech.SYSTEM_SENSORS));
                continue;
            }
            if (crit.content.contains("Cockpit")) {
                mech.setCritical(loc, i, new org.redbat.roguetech.megamek.common.CriticalSlot(
                        org.redbat.roguetech.megamek.common.CriticalSlot.TYPE_SYSTEM, Mech.SYSTEM_COCKPIT));
                continue;
            }
                ...
                if (etype != null) {
                    if (etype.isSpreadable()) {
                        ...
                        if (m != null) {
                            ...
                            mech.addCritical(loc, new org.redbat.roguetech.megamek.common.CriticalSlot(m));
                            continue;
                        }
