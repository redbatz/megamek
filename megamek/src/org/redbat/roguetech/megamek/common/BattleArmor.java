...
public class BattleArmor extends Infantry {
     ...
     *
     * @see Infantry#getArmor(int, boolean )
     */
    @Override
     ...
     * Battle Armor units have no armor on their squad location.
     *
     * @see Infantry#getOArmor(int, boolean )
     */
    @Override
    ...
    public long getEntityType(){
        return ETYPE_INFANTRY | ETYPE_BATTLEARMOR;
    }
