...
public class QuadMech extends Mech {
    ...
    public boolean locationIsLeg(int loc) {
        return ((loc == LOC_RLEG) || (loc == LOC_LLEG) || (loc == LOC_RARM) || (loc == LOC_LARM));
    }
    ...
    public PilotingRollData addEntityBonuses(PilotingRollData roll) {
        ...
        locsToCheck[2] = LOC_RARM;
        locsToCheck[3] = LOC_LARM;
        ...
        for (int loc : locsToCheck) {
            if (isLocationBad(loc)) {
                ...
                if (getBadCriticals(CriticalSlot.TYPE_SYSTEM, ACTUATOR_HIP, loc) > 0) {
                ...
                // upper leg actuators?
                if (getBadCriticals(CriticalSlot.TYPE_SYSTEM, ACTUATOR_UPPER_LEG, loc) > 0) {
                    roll.addModifier(1, getLocationName(loc) + " Upper Leg Actuator destroyed");
                }
                // lower leg actuators?
                if (getBadCriticals(CriticalSlot.TYPE_SYSTEM, ACTUATOR_LOWER_LEG, loc) > 0) {
                    roll.addModifier(1, getLocationName(loc) + " Lower Leg Actuator destroyed");
                }
                // foot actuators?
                if (getBadCriticals(CriticalSlot.TYPE_SYSTEM, ACTUATOR_FOOT, loc) > 0) {
                ...
                if (side == ToHitData.SIDE_FRONT) {
                    ...
                    case 2:
                        if ((getCrew().hasEdgeRemaining()
                            ...
                            result.setUndoneLocation(tac(table, side, LOC_CT, cover, false));
                            return result;
                        } // if
                    ...
                    case 2:
                        if ((getCrew().hasEdgeRemaining()
                            ...
                            getCrew().decreaseEdge();
                            HitData result = rollHitLocation(table, side, aimedLocation, aimingMode, cover);
                            result.setUndoneLocation(tac(table, side, LOC_CT, cover, true));
                            return result;
                        } // if
                    ...
                    case 4:
                    case 5:
                        return new HitData(LOC_LLEG, true);
                    case 6:
                    ...
                    case 9:
                    case 10:
                        return new HitData(LOC_RLEG, true);
                    case 11:
                    ...
                    case 12:
                        if ((getCrew().hasEdgeRemaining()
                            ...
                            getCrew().decreaseEdge();
                            HitData result = rollHitLocation(table, side, aimedLocation, aimingMode, cover);
                            result.setUndoneLocation(new HitData(LOC_HEAD, true));
                            return result;
                        } // if
                    ...
                    case 2:
                        if ((getCrew().hasEdgeRemaining()
                            ...
                            getCrew().decreaseEdge();
                            HitData result = rollHitLocation(table, side, aimedLocation, aimingMode, cover);
                            result.setUndoneLocation(tac(table, side, LOC_LT, cover, false));
                            return result;
                        } // if
                    ...
                    case 2:
                        if ((getCrew().hasEdgeRemaining()
                            ...
                            getCrew().decreaseEdge();
                            HitData result = rollHitLocation(table, side, aimedLocation, aimingMode, cover);
                            result.setUndoneLocation(tac(table, side, LOC_RT, cover, false));
                            return result;
                        } // if
        ...
        if (table == ToHitData.HIT_PUNCH) {
            ...
            case 2:
                if (getCrew().hasEdgeRemaining()
                    ...
                    getCrew().decreaseEdge();
                    HitData result = rollHitLocation(table, side, aimedLocation, aimingMode, cover);
                    result.setUndoneLocation(new HitData(LOC_HEAD, false, effects));
                    return result;
                } // if
    ...
    public boolean hasFunctionalLegAES() {
        ...
        for (Mounted mounted : getMisc()) {
            if ((mounted.getLocation() == LOC_LLEG) || (mounted.getLocation() == LOC_RLEG) || (mounted.getLocation() == LOC_LARM) || (mounted.getLocation() == LOC_RARM)) {
                if (((MiscType) mounted.getType()).hasFlag(MiscType.F_ACTUATOR_ENHANCEMENT_SYSTEM) && !mounted.isDestroyed() && !mounted.isBreached() && !mounted.isMissing()) {
                    if (mounted.getLocation() == LOC_LLEG) {
                        ...
                        rearRightLeg = true;
                    } else if (mounted.getLocation() == LOC_RARM) {
                        frontRightLeg = true;
                    } else {
                        frontLeftLeg = true;
                    }
    ...
    public boolean canGoHullDown() {
        ...
        //check the locations
        int locations[] = {LOC_RARM, LOC_LARM, LOC_LLEG, LOC_RLEG};
        int badLocs = 0;
    ...
    public long getEntityType(){
        return ETYPE_MECH | ETYPE_QUAD_MECH;
    }
