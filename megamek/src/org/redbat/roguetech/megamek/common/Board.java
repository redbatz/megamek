...
import org.redbat.roguetech.megamek.common.event.BoardEvent;
import org.redbat.roguetech.megamek.common.event.BoardListener;
            ...
            for (int x = 0; x < width; x++) {
                    ...
                    if (!bldgByCoords.containsKey(coords)) {
                        ...
                        try {
                            Building bldg = new Building(coords, this, Terrains.BUILDING,
                                    Building.BasementType.getType(curHex.terrainLevel(Terrains.BLDG_BASEMENT_TYPE)));
                ...
                if ((curHex != null) && curHex.containsTerrain(Terrains.BRIDGE)) {
                    ...
                    if (!bldgByCoords.containsKey(coords)) {
                        ...
                        // Nope. Try to create an object for the new building.
                        try {
                            Building bldg = new Building(coords, this, Terrains.BRIDGE, Building.BasementType.NONE);
                            buildings.addElement(bldg);
        ...
        while (loop.hasMoreElements()) {
            ...
            while (coordsEnum.hasMoreElements()) {
                ...
                bldg.setBasement(coords,
                        Building.BasementType.getType(getHex(coords).terrainLevel(Terrains.BLDG_BASEMENT_TYPE)));
    ...
    public void setRandomBasementsOff() {
        ...
        for (Building b : buildings) {
            for (Enumeration<Coords> coords = b.getCoords(); coords.hasMoreElements();) {
                ...
                if (b.getBasement(c) == Building.BasementType.UNKNOWN) {
                    b.setBasement(c, Building.BasementType.NONE);
                }
            }
        }
    }
