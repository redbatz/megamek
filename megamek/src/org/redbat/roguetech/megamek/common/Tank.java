...
import org.redbat.roguetech.megamek.common.verifier.SupportVeeStructure;
...
public class Tank extends Entity {
    ...
    public void applyDamage() {
        ...
        if (isTrailer() && getTractor() != NONE && game.getEntity(getTractor()).hasETypeFlag(ETYPE_TANK)) {
     ...
     *
     * @see Entity#setHullDown(boolean)
     */
    @Override
