...
import org.redbat.roguetech.megamek.common.util.BuildingTemplate;
...
public class MapSettings implements Serializable {
    ...
    private MapSettings() {
        this(PreferenceManager.getClientPreferences().getBoardWidth(),
                PreferenceManager.getClientPreferences().getBoardHeight(),
                PreferenceManager.getClientPreferences().getMapWidth(),
                PreferenceManager.getClientPreferences().getMapHeight());
    }
