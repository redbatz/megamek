...
import org.redbat.roguetech.megamek.common.IGame.Phase;
import org.redbat.roguetech.megamek.common.MovePath.MoveStepType;
import org.redbat.roguetech.megamek.common.actions.*;
import org.redbat.roguetech.megamek.common.annotations.Nullable;
import org.redbat.roguetech.megamek.common.event.GameEntityChangeEvent;
import org.redbat.roguetech.megamek.common.options.*;
...
import org.redbat.roguetech.megamek.common.weapons.battlearmor.ISBAPopUpMineLauncher;
import org.redbat.roguetech.megamek.common.weapons.bayweapons.AR10BayWeapon;
import org.redbat.roguetech.megamek.common.weapons.bayweapons.BayWeapon;
import org.redbat.roguetech.megamek.common.weapons.bayweapons.CapitalMissileBayWeapon;
import org.redbat.roguetech.megamek.common.weapons.bayweapons.TeleOperatedMissileBayWeapon;
...
import org.redbat.roguetech.megamek.common.weapons.other.TSEMPWeapon;
...
public abstract class Entity extends TurnOrdered implements Transporter,
     ...
     *                  {@link TechConstants TechConstants }.
     */
            ...
            if (next.containsTerrain(Terrains.BUILDING)
                ...
                if (((assumedElevation == bldcur)
                    ...
                    // If the basement is collapsed, there is no level 0
                            ...
                            && (nextBasement > Building.BasementType.NONE.getValue())
                            && (collapsedBasement > 0)) {
                        retVal -= Building.BasementType.getType(
                                next.terrainLevel(Terrains.BLDG_BASEMENT_TYPE))
                                              .getDepth();
                    } else {
                        retVal += current.surface();
                    ...
                    if (climb || isJumpingNow) {
                        retVal = bldnex + next.surface();
                                        ...
                                        .terrainLevel(Terrains.BLDG_BASEMENT_TYPE) > Building.BasementType.NONE
                                        .getValue())
                               && (assumedElevation == -Building.BasementType
                            .getType(
