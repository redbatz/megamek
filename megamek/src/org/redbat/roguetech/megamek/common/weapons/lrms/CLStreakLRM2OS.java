 ...
 */
public class CLStreakLRM2OS extends StreakLRMWeapon {
     ...
     *
     */
    public CLStreakLRM2OS() {
        super();
        name = "Streak LRM 2 (OS)";
        setInternalName("CLStreakLRM2OS");
        addLookupName("Clan Streak LRM-2 (OS)");
        addLookupName("Clan Streak LRM 2 (OS)");
        heat = 0;
        rackSize = 2;
        shortRange = 7;
