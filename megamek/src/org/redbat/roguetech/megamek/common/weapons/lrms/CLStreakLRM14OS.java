 ...
 */
public class CLStreakLRM14OS extends StreakLRMWeapon {
     ...
     *
     */
    public CLStreakLRM14OS() {
        super();
        name = "Streak LRM 14 (OS)";
        setInternalName("CLStreakLRM14OS");
        addLookupName("Clan Streak LRM-14 (OS)");
        addLookupName("Clan Streak LRM 14 (OS)");
        heat = 0;
        rackSize = 14;
        shortRange = 7;
