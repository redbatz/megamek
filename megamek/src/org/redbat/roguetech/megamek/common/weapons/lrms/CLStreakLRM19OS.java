 ...
 */
public class CLStreakLRM19OS extends StreakLRMWeapon {
     ...
     *
     */
    public CLStreakLRM19OS() {
        super();
        name = "Streak LRM 19 (OS)";
        setInternalName("CLStreakLRM19OS");
        addLookupName("Clan Streak LRM-19 (OS)");
        addLookupName("Clan Streak LRM 19 (OS)");
        heat = 0;
        rackSize = 19;
        shortRange = 7;
