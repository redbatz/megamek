 ...
 */
public class CLStreakLRM11OS extends StreakLRMWeapon {
     ...
     *
     */
    public CLStreakLRM11OS() {
        super();
        name = "Streak LRM 11 (OS)";
        setInternalName("CLStreakLRM11OS");
        addLookupName("Clan Streak LRM-11 (OS)");
        addLookupName("Clan Streak LRM 11 (OS)");
        heat = 0;
        rackSize = 11;
        shortRange = 7;
