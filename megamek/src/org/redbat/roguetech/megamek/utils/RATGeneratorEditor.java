...
package org.redbat.roguetech.megamek.utils;

import org.redbat.roguetech.megamek.client.ratgenerator.*;
import org.redbat.roguetech.megamek.common.Configuration;
import org.redbat.roguetech.megamek.common.EntityMovementMode;
import org.redbat.roguetech.megamek.common.UnitType;
...
public class RATGeneratorEditor extends JFrame {
    ...
    private static class FactionEditorTableModel extends DefaultTableModel {
        ...
        public Object getValueAt(int row, int col) {
            ...
            case CAT_OMNI_PCT:
                return factionRec.getPctTech(FactionRecord.TechCategory.OMNI, era, rating);
            case CAT_CLAN_PCT:
                return factionRec.getPctTech(FactionRecord.TechCategory.CLAN, era, rating);
            case CAT_SL_PCT:
                return factionRec.getPctTech(FactionRecord.TechCategory.IS_ADVANCED, era, rating);
            case CAT_OMNI_AERO_PCT:
                return factionRec.getPctTech(FactionRecord.TechCategory.OMNI_AERO, era, rating);
            case CAT_CLAN_AERO_PCT:
                return factionRec.getPctTech(FactionRecord.TechCategory.CLAN_AERO, era, rating);
            case CAT_SL_AERO_PCT:
                return factionRec.getPctTech(FactionRecord.TechCategory.IS_ADVANCED_AERO, era, rating);
            case CAT_CLAN_VEE_PCT:
                return factionRec.getPctTech(FactionRecord.TechCategory.CLAN_VEE, era, rating);
            case CAT_SL_VEE_PCT:
                return factionRec.getPctTech(FactionRecord.TechCategory.IS_ADVANCED_VEE, era, rating);
            default:
                return "?";
            }
        }
        ...
        public void setValueAt(Object val, int row, int col) {
            ...
            if (row == 0) {
                ...
                switch ((row - 1) / factionRec.getRatingLevels().size()) {
                case CAT_OMNI_PCT:
                    factionRec.setPctTech(FactionRecord.TechCategory.OMNI, era, rating, value);
                    break;
                case CAT_CLAN_PCT:
                    factionRec.setPctTech(FactionRecord.TechCategory.CLAN, era, rating, value);
                    break;
                case CAT_SL_PCT:
                    factionRec.setPctTech(FactionRecord.TechCategory.IS_ADVANCED, era, rating, value);
                    break;
                case CAT_OMNI_AERO_PCT:
                    factionRec.setPctTech(FactionRecord.TechCategory.OMNI_AERO, era, rating, value);
                    break;
                case CAT_CLAN_AERO_PCT:
                    factionRec.setPctTech(FactionRecord.TechCategory.CLAN_AERO, era, rating, value);
                    break;
                case CAT_SL_AERO_PCT:
                    factionRec.setPctTech(FactionRecord.TechCategory.IS_ADVANCED_AERO, era, rating, value);
                    break;
                case CAT_CLAN_VEE_PCT:
                    factionRec.setPctTech(FactionRecord.TechCategory.CLAN_VEE, era, rating, value);
                    break;
                case CAT_SL_VEE_PCT:
                    factionRec.setPctTech(FactionRecord.TechCategory.IS_ADVANCED_VEE, era, rating, value);
                    break;
                }
            }
        }
