 ...
 *  for more details.
 */
package org.redbat.roguetech.megamek.client.bot;
...
import org.redbat.roguetech.megamek.client.bot.princess.BehaviorSettingsFactory;
import org.redbat.roguetech.megamek.client.bot.princess.ChatCommands;
import org.redbat.roguetech.megamek.client.bot.princess.Princess;
import org.redbat.roguetech.megamek.common.Coords;
import org.redbat.roguetech.megamek.common.IBoard;
...
import org.redbat.roguetech.megamek.server.commands.DefeatCommand;
import org.redbat.roguetech.megamek.server.commands.VictoryCommand;
...
public class ChatProcessorTest {
    ...
    public void testAdditionalPrincessCommands() {
        ...
        Mockito.doNothing().when(mockPrincess).log(ArgumentMatchers.any(Class.class), ArgumentMatchers.anyString(),
                                                   ArgumentMatchers.any(LogLevel.class), ArgumentMatchers.anyString());
        ...
        }).when(mockPrincess).log(ArgumentMatchers.any(Class.class), ArgumentMatchers.anyString(), ArgumentMatchers.any(LogLevel.class),
